...
/* harmony export (immutable) */ __webpack_exports__["parseParams"] = parseParams;
/* harmony export (immutable) */ __webpack_exports__["encodeParams"] = encodeParams;
function parseParams(url = window.location.search) {
	const strippedQuestionMarkSplit = url.replace(/^\?/, '').split('&'),
	      objectified = {};
...
function encodeParams(dataObject = {}) {
	const parametized = [];
